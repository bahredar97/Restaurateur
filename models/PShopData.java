...
public class PShopData implements Parcelable {
    ...
    public String flat_rate_shipping;

    public ArrayList<PCategoryData> categories;

    public ArrayList<PNewsData> feeds;
    ...
    protected PShopData(Parcel in) {
        ...
        flat_rate_shipping = in.readString();
        ...
        if (in.readByte() == 0x01) {
            feeds = new ArrayList<PNewsData>();
            in.readList(feeds, PCategoryData.class.getClassLoader());
        } else {
            feeds = null;
        }
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(flat_rate_shipping);
